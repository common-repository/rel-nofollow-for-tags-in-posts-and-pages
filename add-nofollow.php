...
Plugin Name: Rel Nofollow tag in posts

Plugin URI: hhttp://www.jasminedirectory.com/

Description: This simple plugin ads Nofollow Tags in Posts searches for links to large websites that use the 'nofollow' tags for external links, and puts the same tag on your links to those sites. 
...
function parse_add_nofollow($matches)

{

	//If you would like to add mores sites to add the nofollow tag to, please enter their url in the list below.



	if ( 	wp_inarray(wp_get_domain_name_from_uri($matches[3]), array("110mb.com",
